        ...
        {(() => {
          ...
          return (
            <>
              ...
              {/* [2fr: Loan Terms (top) + You're Owed + Repayment Progress (bottom)] [1fr: Docs] */}
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 14, marginBottom: 20, alignItems: 'start' }}>

                {/* Left (2fr): Loan Terms full-width, then You're Owed + Repayment Progress side-by-side */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  {/* You're Owed + Repayment Progress — each half of left column */}
                ...
                {/* Right (1fr): blue doc buttons only */}
