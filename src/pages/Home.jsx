      ...
      <div className="dashboard-content-wrap" style={{ maxWidth: 1080, margin: '0 auto', padding: '20px 40px 0', position: 'relative', zIndex: 1 }}>
        ...
        <div className="dashboard-grey-box" style={{ marginTop: 0, background: '#E5E2DF', borderRadius: 18, padding: 20 }}>
          <div className="home-top-row" style={{ display: 'grid', gridTemplateColumns: '2fr 0.82fr', columnGap: 20, rowGap: 20, alignItems: 'start' }}>
            ...
            <DashboardCard title="Next payment due" style={{ border: '6px solid #03ACEA', boxShadow: '0 0 0 10px rgba(3,172,234,0.10), 0 0 36px rgba(3,172,234,0.22), ' + SHADOW }}>
            ...
            <DashboardCard title="Next payment incoming" style={{ border: '6px solid #03ACEA', boxShadow: '0 0 0 10px rgba(3,172,234,0.10), 0 0 36px rgba(3,172,234,0.22), ' + SHADOW }}>
              <div style={{ padding: '16px 16px 20px', position: 'relative', display: 'flex', alignItems: 'center', minHeight: 48 }}>
                {nextLenderPayment ? (() => {
            ...
            <div className="dash-right-col" style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <DashboardCard title="Owed to You" style={{ border: '6px solid #03ACEA', boxShadow: '0 0 0 10px rgba(3,172,234,0.10), 0 0 36px rgba(3,172,234,0.22), ' + SHADOW }}>
                <div style={{ padding: '16px 16px 20px', position: 'relative', display: 'flex', alignItems: 'center', minHeight: 48 }}>
