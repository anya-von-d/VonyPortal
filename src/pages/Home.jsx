...
export default function Home() {
  ...
  return (
    <div className="home-with-sidebar" style={{ minHeight: '100vh', position: 'relative', fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", fontSize: 14, lineHeight: 1.5, color: '#1A1918', WebkitFontSmoothing: 'antialiased', paddingLeft: 240, paddingTop: 24, background: '#F5F4F0' }}>
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 28px 64px', position: 'relative', zIndex: 1 }}>
        ...
        {/* Greeting title */}
        <h1 style={{ fontSize: '3.2rem', fontWeight: 600, color: '#1A1918', marginBottom: 20, marginTop: 0, fontFamily: "'Cormorant Garamond', Georgia, serif", letterSpacing: '-0.02em', lineHeight: 1.1 }}>
