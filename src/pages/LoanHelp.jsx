  ...
  return (
    <div className="mesh-layout" style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '180px 1fr 300px', gap: 0, fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ position: 'sticky', top: 0, padding: '24px 8px 0' }}>
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <div style={{ position: 'relative' }} onMouseEnter={() => { if (moreNavCloseTimerRef.current) { clearTimeout(moreNavCloseTimerRef.current); moreNavCloseTimerRef.current = null; } setMoreNavOpen(true); }} onMouseLeave={() => { moreNavCloseTimerRef.current = setTimeout(() => setMoreNavOpen(false), 150); }}>
              <button style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '5px 12px', borderRadius: 9, border: 'none', cursor: 'pointer', fontSize: 12, fontWeight: 600, color: '#1A1918', background: 'rgba(0,0,0,0.04)', fontFamily: "'DM Sans', sans-serif", width: '100%', boxSizing: 'border-box' }}>
      ...
      <div className="mesh-center" style={{ background: 'white', borderRight: '1px solid rgba(0,0,0,0.06)', padding: '40px 48px 80px' }}>
        ...
        {/* Page title */}
        <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: 20, fontWeight: 600, letterSpacing: '-0.02em', color: '#1A1918', marginBottom: 20 }}>Loan Help</div>
