...
export default function RecentActivity({ loans, payments, isLoading, user, allUsers }) {
  ...
  if (isLoading || !user) {
    return (
      ...
      >
        <div className="rounded-lg p-5 max-w-[85%] mx-auto lg:max-w-none" style={{backgroundColor: '#1C4332'}}>
          <p className="text-base font-bold text-[#DBFFEB] mb-4 tracking-tight font-serif">
            Activity
          </p>
      ...
      <div className="rounded-lg p-5 max-w-[85%] mx-auto lg:max-w-none" style={{backgroundColor: '#1C4332'}}>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to={createPageUrl("RecentActivity")}>
            <Button variant="ghost" size="sm" className="text-[#83F384] hover:text-[#DBFFEB] hover:bg-transparent text-xs">
              View All
            </Button>
          </Link>
        </div>
