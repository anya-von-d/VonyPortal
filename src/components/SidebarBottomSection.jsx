...
export default function SidebarBottomSection() {
  ...
  const NotifIcon = ({ type }) => {
    if (type === 'overdue') {
      return (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#E8726E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 1 }}>
    ...
    if (type === 'overdue_incoming') {
      return (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 1 }}>
    ...
    if (type === 'due') {
      return (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 1 }}>
          <circle cx="12" cy="12" r="10"/>
    ...
    if (type === 'offer') {
      return (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#6B3FA0" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            {notifications.map(notif => (
              <div key={notif.key} style={{
                ...
                <span style={{
                  fontSize: 12, fontWeight: 600, color: '#1A1918',
                  fontFamily: "'DM Sans', sans-serif",
                  lineHeight: 1.4,
                }}>
                  {notif.text}
